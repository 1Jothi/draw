...
import { SiteContentProvider } from "@/store/site-content";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Drawvax Infotech — Client Satisfaction is Our Signature" },
      {
        name: "description",
        content:
          "Drawvax Infotech is a front-end development and digital growth studio building premium, fast, animated web experiences.",
      },
      { name: "author", content: "Drawvax Infotech" },
